        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    {
                        byteBuffer2[bytecount] = buffer[i];
                        bytecount++;
                        System.out.println("buffer in old place: " + buffer[i]);
                        if(buffer[i] == 0x1f)
                        {  bytecount = 0;

                            System.out.println("yes we get right data");
                            didI = true;
                        }
                        if(bytecount> 5 && didI)
                        {
                            bytecount = 0;
                            int dist_1 = ((byteBuffer2[0] << 8) | byteBuffer2[1]) / 58;
                           int dist_2 = ((byteBuffer2[2] << 8) | byteBuffer2[3]) / 58;
                           int  dist_3 = ((byteBuffer2[4] << 8) | byteBuffer2[5]) / 58;

                           didI = false;
                            System.out.println("this be value: "+ dist_1);
                            System.out.println("this be value: "+ dist_2);
                            System.out.println("this be value: "+ dist_3);
